<?php
  ...
  while(have_posts()) {
    ...
    <div class="container container--narrow page-section">
        ...
        <p><a class="metabox__blog-home-link" href="<?php echo site_url('/projects'); ?>"><i class="fa fa-home" aria-hidden="true"></i> Projects Home</a> <span class="metabox__main"><?php the_title(); ?></span></p>
      </div>
